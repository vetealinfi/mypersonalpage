			...
			<div class="col-lg-12">
				<div class="thumbnail caja panel" style="padding:30px;">
					...
					<div class="panel-body">
						<?php echo $this->Form->create('Configuration', array('url' => array('controller' => 'configurations', 'action' => 'edit_config'),'type' => 'file', 'id'=>'editProfileForm', 'class'=>'form-horizontal')); ?>
						...
						<div class="um-button-row">
							<?php echo $this->Form->Submit('Editar Configuracion', array('class'=>'btn btn-primary', 'id'=>'editProfileSubmitBtn')); ?>
						</div>
