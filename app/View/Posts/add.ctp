							...
							<div class="col-xs-12">
								...
								<?php echo $this->Form->input('title',array('div'=>false,'label'=>false,'id'=>'form-field-1','placeholder'=>'title','class'=>'col-xs-10 col-sm-5')); ?>	
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<?php echo $this->Form->input('date',array('type'=>'text','div'=>false,'label'=>false,'id'=>'publishing-datepicker','class'=>'form-control date-picker col-xs-10 col-sm-5')); ?>	
										</div>
									</div>
									<!-- /section:elements.form -->
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<div id="cuerpo" class="wysiwyg-editor"><!-- custom html data --></div>
										</div>
									</div>
