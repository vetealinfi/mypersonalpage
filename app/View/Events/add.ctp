							...
							<div class="col-xs-12">
								...
								<?php echo $this->Form->create('Event',array('class'=>'form-horizontal','id'=>'add-event','role'=>'form')); ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div id="event-place" class="wysiwyg-editor"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div id="event-description" class="wysiwyg-editor"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div id="event-body" class="wysiwyg-editor"><!-- custom html data --></div>
											<?php //echo $this->Form->input('cuerpo',array('div'=>false,'label'=>false,'id'=>'event-body','placeholder'=>'cuerpo','class'=>'col-xs-10 col-sm-5')); ?>	
										</div>
									</div>
									<!-- /section:elements.form -->
									...
									<div class="form-group">
										...
										<div class="col-lg-5">
											<input class="form-control" type="text" name="data[Event][dates]" id="day-range" />
									...
									<div class="form-group">
										...
										<div class="col-lg-5">
											<input id="initial_hour" name="data[Event][initial_hour]" type="text" class="form-control col-lg-5" />
									...
									<div class="form-group">
										...
										<div class="col-lg-5">
											<input id="final_hour" name="data[Event][final_hour]" type="text" class="form-control col-lg-5" />
