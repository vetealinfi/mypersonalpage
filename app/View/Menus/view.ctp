...
<h2><?php echo __('Category'); ?></h2>
	<dl>
		...
		<dt><?php echo __('In Menu'); ?></dt>
		<dd>
			<?php echo h($category['Category']['in_menu']); ?>
			&nbsp;
		</dd>
...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('Friendly Url'); ?></th>
		<th><?php echo __('Body'); ?></th>
		<th><?php echo __('Main Img'); ?></th>
	...
	<?php foreach ($category['Post'] as $post): ?>
		<tr>
			...
			<td><?php echo $post['friendly_url']; ?></td>
			<td><?php echo $post['body']; ?></td>
			<td><?php echo $post['main_img']; ?></td>
