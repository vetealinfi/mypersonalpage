				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active"><?php echo __('Agregar Paginas'); ?></li>
					</ul><!-- /.breadcrumb -->
								...
								<?php echo $this->Form->create('Page',array('type' => 'file','id'=>'add-post','class'=>'form-horizontal','role'=>'form')); ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<div id="cuerpo" class="wysiwyg-editor"></div>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<?php echo $this->Form->input('parent_id',array('options'=>$menus,'empty'=>'Principal','div'=>false,'label'=>false,'id'=>'form-field-1','class'=>'col-xs-10 col-sm-5')); ?>
										</div>
									</div>
									<!-- /section:elements.form -->
									<div class="space-4"></div>
