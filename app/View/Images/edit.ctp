				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li>
							<a href="<?php echo $this->Html->url('/Images/'); ?>">Images</a>
						</li>
						<li class="active"><?php echo __('Edit Image'); ?></li>
					</ul><!-- /.breadcrumb -->
					...
					<div class="page-content-area">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<?php echo $this->Form->create('Image',array('class'=>'form-horizontal','role'=>'form')); ?>
								...
								<?php echo $this->Form->input('name',array('div'=>false,'label'=>false,'id'=>'form-field-1','placeholder'=>'name','class'=>'col-xs-10 col-sm-5')); ?>	
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
								<?php echo $this->Form->input('type',array('div'=>false,'label'=>false,'id'=>'form-field-1','placeholder'=>'type','class'=>'col-xs-10 col-sm-5')); ?>	
										</div>
									</div>
									<!-- /section:elements.form -->
									<div class="space-4"></div>
