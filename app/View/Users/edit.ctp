				...
				<div class="breadcrumbs" id="breadcrumbs">
					...
					<ul class="breadcrumb">
						...
						<li class="active"><?php echo __('Editar Usuario'); ?></li>
					</ul><!-- /.breadcrumb -->
						...
						<div class="page-header">
							<h1>
								Usuarios								<small>
									...
									<?php echo __('Editar Usuario'); ?>								</small>
							</h1>
						</div><!-- /.page-header -->
							...
							<div class="col-xs-12">
								...
								<?php echo $this->Form->create('User',array('type' => 'file','id'=>'add-user','class'=>'form-horizontal','role'=>'form')); ?>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div id="description" class="wysiwyg-editor">
												<?php
													echo $this->request->data['User']['description'];
												?>
											</div>
								...
								<?php echo $this->Form->input('contact_email',array('div'=>false,'label'=>false,'id'=>'form-field-1','placeholder'=>'email de contacto','class'=>'col-xs-10 col-sm-5')); ?>	
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<img src="<?php echo $this->Html->url('/img/users/'.$this->request->data['User']['photo']); ?>" style="width:50%;height:auto;" />	
										</div>
									</div>
									<!-- /section:elements.form -->
									<div class="space-4"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<div id="grades" class="wysiwyg-editor">
												<?php
													echo $this->request->data['User']['grades'];
												?>
											</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											...
											<input type="text" name="data[Interest][list]" id="form-field-tags2" value="<?php echo $oldInterestsList; ?>" />
										</div>
									</div>
									<!-- /section:elements.form -->
									<div class="space-4"></div>
